<script setup>
  ...
  const pb = new PocketBase("hhttps://tavue.thomaspoupon.fr:443");
    ...
    <div class="grid grid-cols-12 gap-5 mx-[120px]">
      ...
      <div class=" -mr-[120px] flex flex-col col-start-8 col-span-5 gap-5 pb-5 px-10 border-l-2 border-black">
        ...
        <div class=" flex flex-col gap-5">
          ...
          <p>Couleurs</p>
          <div class="flex gap-5">
            <button v-for="couleur in colors" :key="couleur.id" v-bind:style="{ background: couleur.libelle_couleur }" class="w-[50px] h-[50px] rounded-full border-black border-solid border-2" @click="CouleurChoisi('glasses', couleur)"></button>
          </div>
        ...
        <div class=" flex flex-col gap-5">
          ...
          <p>Couleurs</p>
          <div class="flex gap-5">
            <button v-for="couleur in colors" :key="couleur.id" v-bind:style="{ background: couleur.libelle_couleur }" class="w-[50px] h-[50px] rounded-full border-black border-solid border-2"  @click="CouleurChoisi('monture', couleur)"></button>
          </div>
        ...
        <div class=" flex flex-col gap-5">
          ...
          <p>Couleurs</p>
          <div class="flex gap-5">
            <button v-for="couleur in colors" :key="couleur.id" v-bind:style="{ background: couleur.libelle_couleur }" class="w-[50px] h-[50px] rounded-full border-black border-solid border-2" @click="CouleurChoisi('branch', couleur)"></button>
          </div>
