...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ndvwqr5w")

  // remove
  collection.schema.removeField("atriju6p")

  // remove
  collection.schema.removeField("sjsz4qkq")

  // remove
  collection.schema.removeField("bovjlqrh")

  // remove
  collection.schema.removeField("kymd1mod")

  // remove
  collection.schema.removeField("iyfl8shp")

  // remove
  collection.schema.removeField("pl7bh3vj")

  // remove
  collection.schema.removeField("vezgkaux")
